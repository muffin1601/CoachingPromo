                    ...
                    <section className="content-contact-section">
                        ...
                        <div className="content-contact-options">
                            <div className="content-contact-card">
                                ...
                                <p className="content-contact-card-text">support@coachingpromo.in</p>
                            </div>

                            <div className="content-contact-card">
                                <h3 className="content-contact-card-title">📞 Call Us</h3>
                                <p className="content-contact-card-text">+91 9266 013059</p>
                            </div>
                        </div>
                        ...
                        <div className="content-social-section">
                            ...
                            <div className="content-social-icons">
                                ...
                                {/* WhatsApp */}
                                <a href="https://wa.me/919990590321" target="_blank" rel="noopener noreferrer" className="content-social-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
