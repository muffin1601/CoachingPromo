...
const BlogForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="text" name="media" placeholder="Image or Video URL" onChange={handleChange} />
      <input type="text" name="author" placeholder="Author Name" onChange={handleChange} />
